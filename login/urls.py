...
urlpatterns = [
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', views.reset, name='reset'),
    path('reset-password/', views.reset_password, name='reset_password'),
    url(r'^settings/change-password/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', views.change_password, name='change_password'),
